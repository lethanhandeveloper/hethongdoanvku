                            ...
                            <div class="x_panel" >
                                ...
                                <div class="x_content">
                                    <div class="x_panel" style="min-height: 600px">
                                        <div class="">
                                            <div class="x_content">
                                                <a class="btn btn-primary" href="{{ route('admin.hoidongcham_form') }}">Thêm hội đồng chấm</a>
                                                ...
                                                <table id="datatable-checkbox"
                                                    ...
                                                    <tbody>
                                                        @foreach ($hoidongcham_data as $hoidongcham)
                                                            <tr>
                                                                <td>{{ $hoidongcham->ten }}</td>
                                                                <td>{{ $hoidongcham->tenphong }}</td>
                                                                <td>{{ date("d-m-y H:i:s", strtotime($hoidongcham->ngaybatdau)) }}</td>
                                                                <td>{{ $hoidongcham->giovaosang }}</td>
                                                                <td>
                                                                    @foreach ($hoidongcham->thanhvien as $thanhvien)
                                                                    @if (!empty($thanhvien))
                                                                        <p>{{ $thanhvien->chucdanh.'.'.$thanhvien->hodem.' '.$thanhvien->ten }}</p>
                                                                    @endif
                                                                @endforeach
                                                                </td>
                                                                <td>
